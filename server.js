...
app.get('/api/courses', function(req, res) {
    ...
    let data;
    try {
        data = fs.readFileSync(__dirname + "/data/" + "coursesOffered.json", 'utf8');
        // if (data == null) throw new Error("500 - File Not found");
        data = JSON.parse(data);
        //console.log("Returned data is: ");
    ...
    // let data = fs.readFileSync(__dirname + "/data/" + "coursesOffer.json", 'utf8');
    // data = JSON.parse(data);
    //console.log("Returned data is: ");
    //logArrayOfCourses(data);
    // res.end(JSON.stringify(data));
